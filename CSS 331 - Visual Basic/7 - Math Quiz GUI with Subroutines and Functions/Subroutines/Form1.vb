...
#End Region
        ...
        ElseIf (numCorrect < 5) Then
            ...
            Select Case operator
                ...
                Case "+"
                    ...
                    add(operand1, operand2, correct)

                Case "-"

                    subtract(operand1, operand2, correct)

                Case "*"

                    multiply(operand1, operand2, correct)

                Case "/"

                    divide(operand1, operand2, correct)
    ...
    Private Sub add(ByVal operand1 As Integer, ByVal operand2 As Integer, ByRef correct As Integer)
    ...
    Private Sub subtract(ByVal operand1 As Integer, ByVal operand2 As Integer, ByRef correct As Integer)
    ...
    Private Sub multiply(ByVal operand1 As Integer, ByVal operand2 As Integer, ByRef correct As Integer)
    ...
    Private Sub divide(ByVal operand1 As Integer, ByVal operand2 As Integer, ByRef correct As Integer)
